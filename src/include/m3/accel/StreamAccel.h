...
public:
    ...
    static const epid_t EP_RECV     = 8;
    static const epid_t EP_IN_SEND  = 9;
    static const epid_t EP_IN_MEM   = 10;
    static const epid_t EP_OUT_SEND = 11;
    static const epid_t EP_OUT_MEM  = 12;
