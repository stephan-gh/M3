...
public:
    ...
    void config_recv(epid_t ep, goff_t buf, int order, int msgorder, uint reply_eps);
    void config_send(epid_t ep, label_t lbl, peid_t pe, epid_t dstep, size_t msgsize, word_t crd);
