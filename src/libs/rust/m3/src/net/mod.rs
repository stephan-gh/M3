...
impl NetData{
    ...
    pub fn from_slice(sd: i32, slice: &[u8], src_addr: IpAddr, src_port: u16, dest_addr: IpAddr, dest_port: u16) -> Self{
...
impl core::fmt::Display for NetData{
	...
	write!(f, "NetData(sd={}, size={}, srcaddr={:?}:{}, dstaddr={:?}:{}, data=...)", self.sd, self.size, self.source_addr, self.source_port, self.dest_addr, self.dest_port)
    }
}
