...
use crate::net::{NetData, IpAddr, SocketType, NetChannel};
...
impl NetworkManager {
    ...
    pub fn connect(&self, sd: i32, remote_addr: IpAddr, remote_port: u16, local_addr: IpAddr, local_port: u16) -> Result<(), Error> {
	llog!(
	    DEF,
    ...
    pub fn as_file(&self, _sd: i32, _mode: i32, _mem: &MemGate, _memsize: usize) -> Result<(), Error> {
        //TODO FD?
    ...
    pub fn send(&self, sd: i32, src_addr: IpAddr, src_port: u16, dst_addr: IpAddr, dst_port: u16, data: &[u8]) -> Result<(), Error>{
	...
	let mut res_stream = send_recv_res!(&self.metagate, RecvGate::def(), NetworkOp::QUERY_STATE, sd)?;
