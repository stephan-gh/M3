...
#define XAxiEthernet_indent(RegOffset) \
 ((indent_on && ((RegOffset) <= XAE_AF1_OFFSET)) ? "\t" : "")
...
#define XAxiEthernet_reg_name(RegOffset) \
	...
	((RegOffset) == XAE_MDIO_MC_OFFSET) ? "XAE_MDIO_MC_OFFSET" : \
	((RegOffset) == XAE_MDIO_MCR_OFFSET) ? "XAE_MDIO_MCR_OFFSET" : \
	((RegOffset) == XAE_MDIO_MWD_OFFSET) ? "XAE_MDIO_MWD_OFFSET" : \
	((RegOffset) == XAE_MDIO_MRD_OFFSET) ? "XAE_MDIO_MRD_OFFSET" : \
	"unknown")
