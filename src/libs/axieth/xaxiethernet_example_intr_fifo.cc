...
#define AXIETHERNET_IRPT_INTR	XPAR_AXIETHERNET_0_INTR
#define FIFO_IRPT_INTR		XPAR_AXIETHERNET_0_CONNECTED_FIFO_INTR
//#endif
#endif
...
****************************************************************************/
#ifndef TESTAPP_GEN
int main_example_intr_fifo(void)
{
	int Status;
